...
import { Star, Gamepad2, Users, ArrowRight } from 'lucide-react';
  ...
  return (
    <div>
      ...
      <div className="container home-features">
        <h2 className="home-features-title">BadCat Fórum!</h2>

        <div className="features-grid">

          <div className="game-card feature-card">
            <div className="feature-icon">
              <Star size={48} fill="#ffffffff"/>
            </div>
            <h3>Constantes atualizações!</h3>
            <p>Os devs são altamente ativos! Nosso objetivo é entregar os melhores e mais acessíveis jogos!</p>
          </div>
